 ...
 * 1. Beli kartu tol (buyTollRoadCard) -> isi argumen money dengan angka 25 ->
 * mengembalikan objek { tollRoadCard: true, balance: 0 }.
 * 2. Isi saldo kartu tol (topUpBalance) -> isi argumen card dengan objek card yang didapat
 * dari langkah 1 dan isi argumen amount dengan angka 10 -> mengembalikan objek { tollRoadCard: true, balance: 10 }.
 ...
 * - Anda bisa mengeksplorasi fungsi yang sudah disediakan di utils.js.
 * Namun, Anda tidak boleh mengubah isi dari utils.js.
 */
